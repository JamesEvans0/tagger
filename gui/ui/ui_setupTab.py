...
class Ui_SetupTab(object):
    def setupUi(self, SetupTab):
        ...
        self.label_8 = QtWidgets.QLabel(self.group_generalSettings)
        self.label_8.setObjectName("label_8")
        self.horizontalLayout_3.addWidget(self.label_8)
        self.line_watcherStatus = QtWidgets.QLineEdit(self.group_generalSettings)
        self.line_watcherStatus.setEnabled(False)
        self.line_watcherStatus.setObjectName("line_watcherStatus")
        self.horizontalLayout_3.addWidget(self.line_watcherStatus)
        ...
        self.label_9 = QtWidgets.QLabel(self.group_generalSettings)
        self.label_9.setObjectName("label_9")
        self.horizontalLayout_5.addWidget(self.label_9)
        self.line_interopConnectionStatus = QtWidgets.QLineEdit(self.group_generalSettings)
        self.line_interopConnectionStatus.setEnabled(False)
        self.line_interopConnectionStatus.setObjectName("line_interopConnectionStatus")
        self.horizontalLayout_5.addWidget(self.line_interopConnectionStatus)
    ...
    def retranslateUi(self, SetupTab):
        ...
        self.label_8.setText(_translate("SetupTab", "Watcher Status:        "))
        self.label_9.setText(_translate("SetupTab", "Interop Connection:"))
