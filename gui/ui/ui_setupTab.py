...
class Ui_SetupTab(object):
    ...
    def retranslateUi(self, SetupTab):
        ...
        self.edit_flightDate.setToolTip(_translate("SetupTab", "<html><head/><body><p>Enter or select date of flight</p></body></html>"))
        self.button_createFlight.setText(_translate("SetupTab", "Create and Load"))
        self.line_areaMap.setToolTip(_translate("SetupTab", "<html><head/><body><p>Select a map of flight area</p></body></html>"))
        self.label_5.setText(_translate("SetupTab", "Date:"))
        self.line_locationName.setToolTip(_translate("SetupTab", "<html><head/><body><p>Enter location of the flight</p></body></html>"))
        self.line_siteElevation.setToolTip(_translate("SetupTab", "<html><head/><body><p>Enter elevation of the base from sea level</p></body></html>"))
        ...
        self.line_intrinsicMatrix.setToolTip(_translate("SetupTab", "<html><head/><body><p>Select an intrinsic matrix</p></body></html>"))
