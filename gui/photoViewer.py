...
class PhotoViewer(QtWidgets.QGraphicsView):
    ...
    def mousePressEvent(self, QMouseEvent):
        ...
        QtWidgets.QGraphicsView.mousePressEvent(self, QMouseEvent)

    def mouseMoveEvent(self, QMouseEvent):
        if self.crop_enabled and self.rubber_band:
            self.setDragMode(QtWidgets.QGraphicsView.NoDrag)
            self.rubber_band_end_point = self.mapToGlobal(QMouseEvent.pos())
            x = QMouseEvent.pos().x()
            y = QMouseEvent.pos().y()
            ...
            self.rubber_band.setGeometry(QtCore.QRect(self.rubber_band_initial_point, self.rubber_band_end_point))
        QtWidgets.QGraphicsView.mouseMoveEvent(self, QMouseEvent)
    ...
    def mouseReleaseEvent(self, QMouseEvent):
        if self.crop_enabled and self.rubber_band:
            ...
            self.rubber_band = None
            self.setDragMode(QtWidgets.QGraphicsView.ScrollHandDrag)
        QtWidgets.QGraphicsView.mouseReleaseEvent(self, QMouseEvent)
